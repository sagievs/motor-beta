<section id="recommend" class="recommend__about">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="rec-slider col-md-12">
                    ...
                    <div class="rec-col cart-effect col col-lg-2">
                        <a href="{{ route('product', [$product->category->parent->slug, $product->category, $product]) }}"><img src="{{URL::asset('images/'.$product->thumbnail)}}" alt="{{ $product->title }}"></a>
