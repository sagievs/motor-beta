$(document).ready(function() {
	...
	$('input[class="activeCb"]').change( function() {
	  if ( $(this).is(":checked") ) {
	    $(this).val(1);
	...
	$('input[class="isblogCb"]').change( function() {
	  if ( $(this).is(":checked") ) {
	    $(this).val(1);
	    $('input[name="isblog"]').val(1);
	  } else if ( $(this).not(":checked") ) {
	    $(this).val(0);
	    $('input[name="isblog"]').val(0);
	  }
	});
	$('input[class="ismainCb"]').change( function() {
	  if ( $(this).is(":checked") ) {
	    $(this).val(1);
	    $('input[name="ismain"]').val(1);
	  } else if ( $(this).not(":checked") ) {
	    $(this).val(0);
	    $('input[name="ismain"]').val(0);
	  }
	});
	$('input[class="ishomeCb"]').change( function() {
	  if ( $(this).is(":checked") ) {
	    $(this).val(1);
	    $('input[name="ishome"]').val(1);
	  } else if ( $(this).not(":checked") ) {
	    $(this).val(0);
	    $('input[name="ishome"]').val(0);
	  }
	});
});
